...
int main(int argc, char **argv) 
{
  ...
  // Plot to CSV
  if (false)
    pInputMotion->writeCSVfile(inputMotionCaptureFile, 0.06, forceAllJointsBe3DOF);
  if (false)
    pOutputMotion->writeCSVfile(outputMotionCaptureFile, 0.06, forceAllJointsBe3DOF);
